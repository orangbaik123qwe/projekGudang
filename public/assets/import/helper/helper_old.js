        ...
        logout: function(type = 2) {
            HELPER.confirm({
                ...
                callback: function(result) {
                    if (result) {
                        HELPER.ajax({
                            url: APP_URL + (type == 2) ? 'login/logout' : 'app-login/logout',
                            data: {},
                            type: 'POST',
                ...
                $.ajax({
                    ...
                    complete: function(pages) {
                        ...
                        $('#titleContent').html('').html(`
                            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1 parentTitle">${responseObject.menu_title}</h1>
                        `);
                        resolve(pages);
                    },
